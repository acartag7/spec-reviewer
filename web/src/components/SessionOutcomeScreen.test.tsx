...
test("finished outcome shows the submitted state, counts, and closes the window", () => {
  const close = vi.spyOn(window, "close").mockImplementation(() => {})
  render(<SessionOutcomeScreen outcome="finished" openAnnotations={2} carriedOver={3} />)
